...
4:                                                ; preds = %1
  ...
  call void @zero_kernel_bf16(ptr @C_L1L2_7_2_buff_0)
  br label %5
...
8:                                                ; preds = %5
  ...
  call void @matmul_vectorized_different_datatypes(ptr @A_L2L1_2_7_cons_buff_0, ptr @B_L2L1_7_2_cons_buff_0, ptr @C_L1L2_7_2_buff_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @matmul_vectorized_different_datatypes(ptr @A_L2L1_2_7_cons_buff_1, ptr @B_L2L1_7_2_cons_buff_0, ptr @C_L1L2_7_2_buff_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @matmul_vectorized_different_datatypes(ptr @A_L2L1_2_7_cons_buff_0, ptr @B_L2L1_7_2_cons_buff_0, ptr @C_L1L2_7_2_buff_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  call void @llvm.aie2p.acquire(i32 51, i32 -1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @matmul_vectorized_different_datatypes(ptr @A_L2L1_2_7_cons_buff_0, ptr @B_L2L1_7_2_cons_buff_1, ptr @C_L1L2_7_2_buff_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @matmul_vectorized_different_datatypes(ptr @A_L2L1_2_7_cons_buff_1, ptr @B_L2L1_7_2_cons_buff_1, ptr @C_L1L2_7_2_buff_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @matmul_vectorized_different_datatypes(ptr @A_L2L1_2_7_cons_buff_0, ptr @B_L2L1_7_2_cons_buff_1, ptr @C_L1L2_7_2_buff_0)
  call void @llvm.aie2p.release(i32 48, i32 1)

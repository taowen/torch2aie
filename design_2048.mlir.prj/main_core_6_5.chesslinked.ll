...
8:                                                ; preds = %5
  ...
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @A_L2L1_3_6_cons_buff_0, ptr @B_L2L1_6_3_cons_buff_0, ptr @C_L1L2_6_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @A_L2L1_3_6_cons_buff_1, ptr @B_L2L1_6_3_cons_buff_0, ptr @C_L1L2_6_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @A_L2L1_3_6_cons_buff_0, ptr @B_L2L1_6_3_cons_buff_0, ptr @C_L1L2_6_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  ...
  call addrspace(0) void @llvm.aie2p.acquire(i32 51, i32 -1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @A_L2L1_3_6_cons_buff_0, ptr @B_L2L1_6_3_cons_buff_1, ptr @C_L1L2_6_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @A_L2L1_3_6_cons_buff_1, ptr @B_L2L1_6_3_cons_buff_1, ptr @C_L1L2_6_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  call addrspace(0) void @matmul_vectorized_different_datatypes(ptr @A_L2L1_3_6_cons_buff_0, ptr @B_L2L1_6_3_cons_buff_1, ptr @C_L1L2_6_3_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)

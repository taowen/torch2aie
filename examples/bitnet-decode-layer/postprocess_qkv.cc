...
constexpr int32_t kQRecords = 5;   // BitNet: 5 Q blocks (ceil(2560/512))
constexpr int32_t kKvRecords = 2;  // BitNet: 2 KV blocks (ceil(640/512))
...
static void write_qwen3_current_even_odd(
    ...
    constexpr int32_t kv_heads = 5;   // BitNet: 5 KV heads
    constexpr int32_t head_dim = 128;
...
void bitnet_postprocess_body_payload(
    ...
    constexpr int32_t q_heads = 20;  // BitNet: 20 Q heads
    constexpr int32_t head_dim = 128;

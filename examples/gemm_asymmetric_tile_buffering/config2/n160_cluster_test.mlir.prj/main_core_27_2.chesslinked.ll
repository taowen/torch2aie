...
define void @core_27_2() addrspace(0) {
...
4:                                                ; preds = %1
  ...
  call addrspace(0) void @zero_kernel(ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.acquire(i32 51, i32 -1)
  %5 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 4), align 4
  %6 = sext i32 %5 to i64
...
7:                                                ; preds = %90, %88, %4
  %8 = phi ptr [ %91, %90 ], [ %89, %88 ], [ @B_L2L1_27_0_cons_buff_0, %4 ]
  %9 = getelementptr [128 x [12 x i72]], ptr %8, i32 0, i32 0, i32 0
  br label %10

10:                                               ; preds = %7
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  %11 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
...
13:                                               ; preds = %94, %92, %10
  %14 = phi ptr [ %95, %94 ], [ %93, %92 ], [ @A_L2L1_0_3_3_cons_buff_0, %10 ]
  %15 = getelementptr [32 x [16 x i72]], ptr %14, i32 0, i32 0, i32 0
  br label %16

16:                                               ; preds = %13
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %15, ptr %9, ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  %17 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  %18 = add i32 %17, 1
  %19 = icmp sge i32 %18, 2
  %20 = add i32 %17, -1
  %21 = select i1 %19, i32 %20, i32 %18
  store i32 %21, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  %22 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
...
24:                                               ; preds = %98, %96, %16
  %25 = phi ptr [ %99, %98 ], [ %97, %96 ], [ @A_L2L1_0_3_3_cons_buff_0, %16 ]
  %26 = getelementptr [32 x [16 x i72]], ptr %25, i32 0, i32 0, i32 0
  br label %27

27:                                               ; preds = %24
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %26, ptr %9, ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  %28 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  %29 = add i32 %28, 1
  %30 = icmp sge i32 %29, 2
  %31 = add i32 %28, -1
  %32 = select i1 %30, i32 %31, i32 %29
  store i32 %32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  %33 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
...
35:                                               ; preds = %102, %100, %27
  %36 = phi ptr [ %103, %102 ], [ %101, %100 ], [ @A_L2L1_0_3_3_cons_buff_0, %27 ]
  %37 = getelementptr [32 x [16 x i72]], ptr %36, i32 0, i32 0, i32 0
  br label %38

38:                                               ; preds = %35
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %37, ptr %9, ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  %39 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  %40 = add i32 %39, 1
  %41 = icmp sge i32 %40, 2
  %42 = add i32 %39, -1
  %43 = select i1 %41, i32 %42, i32 %40
  store i32 %43, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  %44 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
...
46:                                               ; preds = %106, %104, %38
  %47 = phi ptr [ %107, %106 ], [ %105, %104 ], [ @A_L2L1_0_3_3_cons_buff_0, %38 ]
  %48 = getelementptr [32 x [16 x i72]], ptr %47, i32 0, i32 0, i32 0
  br label %49

49:                                               ; preds = %46
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %48, ptr %9, ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  %50 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  %51 = add i32 %50, 1
  %52 = icmp sge i32 %51, 2
  %53 = add i32 %50, -1
  %54 = select i1 %52, i32 %53, i32 %51
  store i32 %54, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  %55 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
...
57:                                               ; preds = %110, %108, %49
  %58 = phi ptr [ %111, %110 ], [ %109, %108 ], [ @A_L2L1_0_3_3_cons_buff_0, %49 ]
  %59 = getelementptr [32 x [16 x i72]], ptr %58, i32 0, i32 0, i32 0
  br label %60

60:                                               ; preds = %57
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %59, ptr %9, ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  %61 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  %62 = add i32 %61, 1
  %63 = icmp sge i32 %62, 2
  %64 = add i32 %61, -1
  %65 = select i1 %63, i32 %64, i32 %62
  store i32 %65, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  call addrspace(0) void @llvm.aie2p.acquire(i32 49, i32 -1)
  %66 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
...
68:                                               ; preds = %114, %112, %60
  %69 = phi ptr [ %115, %114 ], [ %113, %112 ], [ @A_L2L1_0_3_3_cons_buff_0, %60 ]
  %70 = getelementptr [32 x [16 x i72]], ptr %69, i32 0, i32 0, i32 0
  br label %71

71:                                               ; preds = %68
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %70, ptr %9, ptr @C_L1L2_27_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
  %72 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  %73 = add i32 %72, 1
  %74 = icmp sge i32 %73, 2
  %75 = add i32 %72, -1
  %76 = select i1 %74, i32 %75, i32 %73
  store i32 %76, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 8), align 4
  call addrspace(0) void @llvm.aie2p.release(i32 50, i32 1)
  %77 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 4), align 4
  %78 = add i32 %77, 1
  %79 = icmp sge i32 %78, 2
  %80 = add i32 %77, -1
  %81 = select i1 %79, i32 %80, i32 %78
  store i32 %81, ptr getelementptr inbounds (i8, ptr @_anonymous27, i64 4), align 4
  call addrspace(0) void @llvm.aie2p.release(i32 53, i32 1)
  %82 = load i32, ptr @_anonymous27, align 4
  %83 = add i32 %82, 1
  %84 = icmp sge i32 %83, 1
  %85 = select i1 %84, i32 %82, i32 %83
  store i32 %85, ptr @_anonymous27, align 4
  %86 = add i64 %2, 1
  br label %1
...
88:                                               ; preds = %4
  %89 = phi ptr [ @B_L2L1_27_0_cons_buff_0, %4 ]
  br label %7

90:                                               ; preds = %4
  %91 = phi ptr [ @B_L2L1_27_0_cons_buff_1, %4 ]
  br label %7

92:                                               ; preds = %10
  %93 = phi ptr [ @A_L2L1_0_3_3_cons_buff_0, %10 ]
  br label %13

94:                                               ; preds = %10
  %95 = phi ptr [ @A_L2L1_0_3_3_cons_buff_1, %10 ]
  br label %13

96:                                               ; preds = %16
  %97 = phi ptr [ @A_L2L1_0_3_3_cons_buff_0, %16 ]
  br label %24

98:                                               ; preds = %16
  %99 = phi ptr [ @A_L2L1_0_3_3_cons_buff_1, %16 ]
  br label %24

100:                                              ; preds = %27
  %101 = phi ptr [ @A_L2L1_0_3_3_cons_buff_0, %27 ]
  br label %35

102:                                              ; preds = %27
  %103 = phi ptr [ @A_L2L1_0_3_3_cons_buff_1, %27 ]
  br label %35

104:                                              ; preds = %38
  %105 = phi ptr [ @A_L2L1_0_3_3_cons_buff_0, %38 ]
  br label %46

106:                                              ; preds = %38
  %107 = phi ptr [ @A_L2L1_0_3_3_cons_buff_1, %38 ]
  br label %46

108:                                              ; preds = %49
  %109 = phi ptr [ @A_L2L1_0_3_3_cons_buff_0, %49 ]
  br label %57

110:                                              ; preds = %49
  %111 = phi ptr [ @A_L2L1_0_3_3_cons_buff_1, %49 ]
  br label %57

112:                                              ; preds = %60
  %113 = phi ptr [ @A_L2L1_0_3_3_cons_buff_0, %60 ]
  br label %68

114:                                              ; preds = %60
  %115 = phi ptr [ @A_L2L1_0_3_3_cons_buff_1, %60 ]
  br label %68
}

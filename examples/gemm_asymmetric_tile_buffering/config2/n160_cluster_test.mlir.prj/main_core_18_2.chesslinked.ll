...
define void @core_18_2() addrspace(0) {
...
4:                                                ; preds = %1
  ...
  call addrspace(0) void @zero_kernel(ptr @C_L1L2_18_0_buff_0)
...
16:                                               ; preds = %13
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %15, ptr %9, ptr @C_L1L2_18_0_buff_0)
...
27:                                               ; preds = %24
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %26, ptr %9, ptr @C_L1L2_18_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
...
38:                                               ; preds = %35
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %37, ptr %9, ptr @C_L1L2_18_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
...
49:                                               ; preds = %46
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %48, ptr %9, ptr @C_L1L2_18_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
...
60:                                               ; preds = %57
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %59, ptr %9, ptr @C_L1L2_18_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
...
71:                                               ; preds = %68
  call addrspace(0) void @matmul_vectorized_bfp16(ptr %70, ptr %9, ptr @C_L1L2_18_0_buff_0)
  call addrspace(0) void @llvm.aie2p.release(i32 48, i32 1)
